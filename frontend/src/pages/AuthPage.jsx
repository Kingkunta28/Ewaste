...
export default function AuthPage({ onLogin, onBack }) {
  ...
  return (
    <div className="auth-page">
      <button className="auth-home" type="button" onClick={onBack}>
        <BrandMark />
      </button>
      <section className="auth-showcase">
        <div className="auth-art">
          <img src="/eco-hero.png" alt="" aria-hidden="true" />
        </div>
        <div className="auth-showcase-copy">
          <span className="auth-pill">
            <span aria-hidden="true">♻</span> Smarter recycling
          </span>
          <h1>
            Every device has
            <br />
            <em>a next chapter.</em>
          </h1>
          <p>
            Join a growing community making electronics disposal safe,
          ...
          <div className="auth-proof">
            ...
            <div>
              ...
              <small>already recycling smarter</small>
            </div>
          </div>
        </div>
      ...
      <section className="auth-panel">
        <div className="auth-panel-inner">
          ...
          <div className="auth-mobile-story">
            ...
            <h1>
              Every device has <em>a next chapter.</em>
            </h1>
            <p>
              Sustainable e-waste collection made safe, transparent, and simple.
            </p>
          </div>
          {!showResetPassword ? (
            <>
              <div className="auth-heading">
                <span className="auth-mini-logo">
                  <BrandMark compact />
                </span>
                <h2>
                ...
                <p>
                  {mode === "login"
                    ...
                    : "Start your journey toward responsible recycling."}
                </p>
              </div>
              <div className="tabs">
                <button
              ...
              <form className="auth-form" onSubmit={submit}>
                    ...
                    <small>
                      {form.password.length >= 10
                        ...
                        : form.password.length >= 7
                          ? "Good password"
                          : "Keep strengthening your password"}
                    </small>
                  </div>
                ) : null}
                {mode === "register" ? (
                ...
                {authMessage ? (
                  <p className="success message-box">{authMessage}</p>
                ) : null}
                {resetMessage ? (
                  <p className="success message-box">{resetMessage}</p>
                ) : null}
                <button
            ...
            <>
              <div className="auth-heading">
                ...
                <p>
                  Enter your account email and choose a secure new password.
                </p>
              </div>
              <form className="auth-form" onSubmit={submitResetPassword}>
                <label className="field-label">
                  ...
                  <div className="input-shell">
                    ...
                    <input
                      ...
                      onChange={(e) => onResetChange("email", e.target.value)}
                      required
                    />
                  </div>
                </label>
                <PasswordField
                  ...
                  onChange={(e) =>
                    onResetChange("new_password", e.target.value)
                  }
                  visible={showResetNewPassword}
                  onToggle={() => setShowResetNewPassword((value) => !value)}
                />
                <PasswordField
                  label="Confirm password"
                  value={resetForm.confirm_password}
                  onChange={(e) =>
                    onResetChange("confirm_password", e.target.value)
                  }
